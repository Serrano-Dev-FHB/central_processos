...
export default function Layout({children, ...props}) {
   ...
   const caixa_entrada = () => {
        const color =  router.pathname == "/home" ? "black" : "white";
   ...
   const processos = () => {
        const color = router.pathname == "/home/processos" ? "black" : "white";
   ...
   const dashboard = () => {
        const color = router.pathname == "/home/dashboard" ? "black" : "white";
    ...
    const admin = () => {
        const color = router.pathname == "/home/admin" ? "black" : "white";
    ...
    return (
        <>
            ...
            <div className="container">
                <div className={(statusNavbar) ? "container_navigator" : "container_navigator container_navigator_desabled"}>
                    <div className="container_navigator_header">
                        <Image src={statusNavbar ? logo : logoDesabled} />
                    </div>
                    <div className="container_navigator_menu">
                        <button onClick={() => setStatusNavbar(!statusNavbar)}>
                            <Image src={statusNavbar ? arrowLeft : arrowRight} />
                        </button>
                    </div>
                    <div className={(statusNavbar) ? "container_navigator_list" : "container_navigator_list_desabled"}>
                        <ul>
                            <Link href="/home">
                                <li className={router.pathname == "/home" ? "active" : ""}>{caixa_entrada()}</li>
                            </Link>
                            <Link href="/home/processos">
                                <li className={router.pathname == "/home/processos" ? "active" : ""}>{processos()}</li>
                            </Link>
                            <Link href="/home/dashboard">
                                <li className={router.pathname == "/home/dashboard" ? "active" : ""}>{dashboard()}</li>
                            </Link>
                            <Link href="/home/admin">
                                <li className={router.pathname == "/home/admin" ? "active" : ""}>{admin()}</li>
                            </Link>
                        </ul>
                    </div>
                </div>
                <div className={(statusNavbar) ? "container_content container_navigator_active" : "container_content"}>
